    ...
    <main id="paper-main">
      ...
      <section id="our-story" className="about-editorial" aria-labelledby="about-story">
        ...
        <div className="about-columns">
          <div><h2 id="about-story">Nobody asked for<br />another launchpad.</h2><p className="about-lede">They asked for the one they already use to stop hiding things.</p></div>
      ...
      <section className="about-principles" aria-labelledby="about-principles-title">
        <div className="about-principles-heading"><p className="pad-kicker">Three rules</p><h2 id="about-principles-title">Chain truth.<br />Plain words.</h2><p>We don’t bend these.</p></div>
      ...
      <section className="about-desk" aria-labelledby="about-desk-title">
        ...
        <h2 id="about-desk-title">What we’re building.</h2>
      ...
      <section className="about-signoff" aria-labelledby="about-signoff-title"><h2 id="about-signoff-title">See it clearly.</h2><a className="pad-btn pad-btn--dark" href="/explore">Open Explore</a></section>
    </main>
    <PaperFooter />
  </div>
}

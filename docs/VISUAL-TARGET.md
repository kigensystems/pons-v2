...
- Latest CRT revision: [desktop before](screenshots/crt-before-desktop.png), [desktop after](screenshots/crt-after-desktop.png), [mobile before](screenshots/crt-before-mobile.png), [mobile after](screenshots/crt-after-mobile.png). Same paused opening picture at each viewport. Brighter picture, tight/soft highlight bloom, stronger inner-bezel and rear-keyboard reflections. These are implementation evidence awaiting user assessment.

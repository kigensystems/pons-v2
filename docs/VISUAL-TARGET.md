...
- Latest directional-light revision: [desktop before](screenshots/directional-before-desktop.png), [desktop after](screenshots/directional-after-desktop.png), [mobile before](screenshots/directional-before-mobile.png), [mobile after](screenshots/directional-after-mobile.png). Same paused opening picture at each viewport. Clearer front-to-side shadow transition and a darker, less defined floor; TV remains luminous. These are implementation evidence awaiting user assessment.
